...
public class Absen extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//        drawer
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent home = new Intent(Absen.this, Homesiswa.class);
            ...
            Intent reqjadwal = new Intent(Absen.this, Siswareqjadwal.class);
            ...
            Intent absen = new Intent(Absen.this, Absen.class);
            ...
            Intent nilai = new Intent(Absen.this, Nilai.class);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("YA", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(Absen.this, Login.class);
                            finish();
